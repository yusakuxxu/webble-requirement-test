      ...
      <table class="table">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <p v-show="this.device === 'pc'">Google Chromeをご利用ください（<a target="_blank" rel="noopener noreferrer" href="https://www.google.com/chrome/">Google Chrome サイト</a>）</p>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              ...
              <div v-else-if="this.os_name === 'Android'">
                <p v-show="parseInt(this.os_version, 10) < 6">Android OSは、6以上の必要がございます。</p>
              </div>
              ...
              <div v-else>
                ...
                （<a target="_blank" rel="noopener noreferrer" href="https://github.com/WebBluetoothCG/web-bluetooth/blob/master/implementation-status.md">Web Bluetooth API公式サイト（英語）</a>）</p>
              </div>
            </td>
          </tr>
        </tbody>
